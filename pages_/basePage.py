...
class BasePage():
    ...
    def _find_element(self, locator):
        try:
            ...
            logger("ERROR", "Element not found or wrong")
            exit(1)
    ...
    def _click(self, webElement):
        webElement.click()
        logger("INFO", "The element successfully clicked")
    ...
    def _get_title(self):
        logger("INFO", "The title successfully found")
    ...
    def _mouse_move(self, element):
        ...
        action.perform()
        logger("INFO", "Mouse successfully moved to element")
